...
MemAddr JitCallback::GetJitFunc(const asmjit::FuncSignature& sig, MethodRef method, CallbackHandler callback, MemAddr data, bool) {
	if (_function) 
		return _function;
	...
	*/
	...
	auto retSize = static_cast<uint32_t>(sizeof(uint64_t));
#else
