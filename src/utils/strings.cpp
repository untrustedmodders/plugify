...
std::wstring String::UTF8StringToWideString(const std::string_view str){
	std::wstring ret;
...
bool String::UTF8StringToWideString(std::wstring& dest, const std::string_view str) {
...
std::string String::WideStringToUTF8String(const std::wstring_view str) {
	std::string ret;
...
bool String::WideStringToUTF8String(std::string& dest, const std::wstring_view str) {
