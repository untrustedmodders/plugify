...
bool Extension::IsValidTransition(ExtensionState from, ExtensionState to) {
	...
	switch (from) {
		...
		case ExtensionState::Discovered:
			return to == ExtensionState::Parsing || to == ExtensionState::Failed;

		case ExtensionState::Parsing:
			return to == ExtensionState::Parsed || to == ExtensionState::Corrupted;
		...
		case ExtensionState::Running:
			return to == ExtensionState::Ending || to == ExtensionState::Failed;

		case ExtensionState::Ending:
			return to == ExtensionState::Ended || to == ExtensionState::Failed;
