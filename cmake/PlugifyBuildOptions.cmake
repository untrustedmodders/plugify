...
option(PLUGIFY_USE_EXTERNAL_VALIJSON "Use external valijson library." OFF)
...
set(PLUGIFY_LIBSOLV_TAG "0.7.39" CACHE STRING "")
set(PLUGIFY_ASMJIT_REPO "https://github.com/asmjit/asmjit.git" CACHE STRING "")
set(PLUGIFY_ASMJIT_TAG "0bd5787b54b575ed94bf32ac452153b34385c514" CACHE STRING "")
set(PLUGIFY_FMT_REPO "https://github.com/fmtlib/fmt.git" CACHE STRING "")
set(PLUGIFY_FMT_TAG "10.2.1" CACHE STRING "")
set(PLUGIFY_TRACY_REPO "https://github.com/wolfpld/tracy.git" CACHE STRING "")
set(PLUGIFY_TRACY_TAG "v0.13.1" CACHE STRING "")
set(PLUGIFY_CATCH2_REPO "https://github.com/catchorg/Catch2.git" CACHE STRING "")
set(PLUGIFY_CATCH2_TAG "v3.15.0" CACHE STRING "")
set(PLUGIFY_CLI_REPO "https://github.com/CLIUtils/CLI11.git" CACHE STRING "")
set(PLUGIFY_CLI_TAG "v2.6.2" CACHE STRING "")
set(PLUGIFY_VALIJSON_REPO "https://github.com/tristanpenman/valijson.git" CACHE STRING "")
set(PLUGIFY_VALIJSON_TAG "v1.1.2" CACHE STRING "")
set(PLUGIFY_GLAZE_REPO "https://github.com/stephenberry/glaze.git" CACHE STRING "")
if (PLUGIFY_DEFAULT_CXX_STANDARD GREATER 20)
    set(PLUGIFY_GLAZE_TAG "v8.0.0" CACHE STRING "")
else()
